...
type V0040CronEntry struct {
	...
	Line *V0041JobDescMsgCrontabLine `json:"line,omitempty"`
}
...
func (o *V0040CronEntry) GetLine() V0041JobDescMsgCrontabLine {
	if o == nil || IsNil(o.Line) {
		var ret V0041JobDescMsgCrontabLine
		return ret
	}
	return *o.Line
}
...
// SetLine gets a reference to the given V0041JobDescMsgCrontabLine and assigns it to the Line field.
