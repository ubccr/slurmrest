...
type V0041JobDescMsg struct {
	...
	BeginTime *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"begin_time,omitempty"`
	...
	// Number of reserve communication ports. Can only be used if slurmstepd step manager is enabled.
	...
	KillWarningDelay *V0041JobDescMsgDistributionPlaneSize `json:"kill_warning_delay,omitempty"`
	...
	RequiredSwitches *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"required_switches,omitempty"`
...
// SetBeginTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the BeginTime field.
...
// SetKillWarningDelay gets a reference to the given V0041JobDescMsgDistributionPlaneSize and assigns it to the KillWarningDelay field.
...
// SetRequiredSwitches gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the RequiredSwitches field.
