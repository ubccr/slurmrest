...
type V0041OpenapiDiagRespStatistics struct {
	...
	ReqTime *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"req_time,omitempty"`
	ReqTimeStart *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"req_time_start,omitempty"`
	...
	JobStatesTs *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"job_states_ts,omitempty"`
	...
	BfWhenLastCycle *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"bf_when_last_cycle,omitempty"`
...
// SetReqTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the ReqTime field.
...
// SetReqTimeStart gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the ReqTimeStart field.
...
// SetJobStatesTs gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the JobStatesTs field.
...
// SetBfWhenLastCycle gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the BfWhenLastCycle field.
