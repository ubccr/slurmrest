...
type V0041OpenapiNodesRespNodesInner struct {
	...
	BootTime *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"boot_time,omitempty"`
	...
	FreeMem *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"free_mem,omitempty"`
	...
	LastBusy *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"last_busy,omitempty"`
	...
	ReasonChangedAt *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"reason_changed_at,omitempty"`
	ReasonSetByUser *string `json:"reason_set_by_user,omitempty"`
	ResumeAfter *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"resume_after,omitempty"`
	...
	SlurmdStartTime *V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu `json:"slurmd_start_time,omitempty"`
...
// SetBootTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the BootTime field.
...
// SetFreeMem gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the FreeMem field.
...
// SetLastBusy gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the LastBusy field.
...
// SetReasonChangedAt gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the ReasonChangedAt field.
...
// SetResumeAfter gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the ResumeAfter field.
...
// SetSlurmdStartTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu and assigns it to the SlurmdStartTime field.
