...
// V0041OpenapiNodesRespNodesInnerEnergy struct for V0041OpenapiNodesRespNodesInnerEnergy
type V0041OpenapiNodesRespNodesInnerEnergy struct {
	...
	CurrentWatts *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"current_watts,omitempty"`
...
// SetCurrentWatts gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the CurrentWatts field.
