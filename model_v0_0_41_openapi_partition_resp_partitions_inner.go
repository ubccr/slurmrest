...
type V0041OpenapiPartitionRespPartitionsInner struct {
	...
	SuspendTime *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"suspend_time,omitempty"`
}
...
// SetSuspendTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the SuspendTime field.
