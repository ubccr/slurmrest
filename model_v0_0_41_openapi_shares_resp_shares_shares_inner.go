...
type V0041OpenapiSharesRespSharesSharesInner struct {
	...
	Fairshare *V0041OpenapiSharesRespSharesSharesInnerFairshare `json:"fairshare,omitempty"`
...
func (o *V0041OpenapiSharesRespSharesSharesInner) GetFairshare() V0041OpenapiSharesRespSharesSharesInnerFairshare {
	if o == nil || IsNil(o.Fairshare) {
		var ret V0041OpenapiSharesRespSharesSharesInnerFairshare
		return ret
	}
	return *o.Fairshare
}
...
// SetFairshare gets a reference to the given V0041OpenapiSharesRespSharesSharesInnerFairshare and assigns it to the Fairshare field.
