...
type V0041OpenapiSlurmdbdConfigRespAccountsInner struct {
	Associations []V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation `json:"associations,omitempty"`
...
// SetAssociations gets a reference to the given []V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation and assigns it to the Associations field.
