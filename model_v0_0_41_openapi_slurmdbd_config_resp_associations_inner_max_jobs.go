...
type V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobs struct {
	...
	Active *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"active,omitempty"`
	Accruing *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"accruing,omitempty"`
	Total *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"total,omitempty"`
}
...
// SetActive gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Active field.
...
// SetTotal gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Total field.
