...
type V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPer struct {
	Count *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"count,omitempty"`
	Accruing *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"accruing,omitempty"`
	Submitted *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"submitted,omitempty"`
	WallClock *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"wall_clock,omitempty"`
}
...
// SetCount gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Count field.
...
// SetAccruing gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Accruing field.
...
// SetSubmitted gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Submitted field.
...
// SetWallClock gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the WallClock field.
