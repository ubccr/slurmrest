...
type V0041OpenapiSlurmdbdConfigRespQosInner struct {
	...
	Priority *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"priority,omitempty"`
	UsageFactor *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor `json:"usage_factor,omitempty"`
	UsageThreshold *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor `json:"usage_threshold,omitempty"`
}
...
// SetPriority gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Priority field.
...
// SetUsageFactor gets a reference to the given V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor and assigns it to the UsageFactor field.
...
// SetUsageThreshold gets a reference to the given V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor and assigns it to the UsageThreshold field.
