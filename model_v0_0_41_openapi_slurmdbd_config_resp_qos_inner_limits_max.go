...
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMax struct {
	...
	Accruing *V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs `json:"accruing,omitempty"`
}
...
// SetAccruing gets a reference to the given V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs and assigns it to the Accruing field.
