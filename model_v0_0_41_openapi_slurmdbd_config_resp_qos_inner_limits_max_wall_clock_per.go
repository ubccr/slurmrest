...
type V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer struct {
	Qos *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"qos,omitempty"`
	Job *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"job,omitempty"`
}
...
// SetQos gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Qos field.
...
// SetJob gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Job field.
