...
type V0041OpenapiSlurmdbdConfigRespQosInnerPreempt struct {
	...
	ExemptTime *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"exempt_time,omitempty"`
}
...
// SetExemptTime gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the ExemptTime field.
