...
type V0041OpenapiSlurmdbdJobsRespJobsInnerTime struct {
	...
	Limit *V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId `json:"limit,omitempty"`
...
// SetLimit gets a reference to the given V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId and assigns it to the Limit field.
