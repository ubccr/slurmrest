...
type V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInner struct {
	...
	Time *V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInnerTime `json:"time,omitempty"`
}
...
func (o *V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInner) GetTime() V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInnerTime {
	if o == nil || IsNil(o.Time) {
		var ret V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInnerTime
		return ret
	}
	return *o.Time
}
...
// SetTime gets a reference to the given V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInnerTime and assigns it to the Time field.
