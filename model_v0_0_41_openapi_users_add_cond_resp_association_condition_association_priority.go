...
// checks if the V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority{}

// V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority Association priority
type V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority struct {
...
func NewV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority {
	this := V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority{}
	return &this
}
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority struct {
	value *V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority
	isSet bool
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) Get() *V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority {
	return v.value
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) Set(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority(val *V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority {
	return &NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority{value: val, isSet: true}
}

func (v NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
