...
type V0044Assoc struct {
	...
	Default *V0044AssocDefault `json:"default,omitempty"`
...
// SetDefault gets a reference to the given V0044AssocDefault and assigns it to the Default field.
