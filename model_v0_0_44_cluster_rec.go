...
type V0044ClusterRec struct {
	Controller *V0044ClusterRecController `json:"controller,omitempty"`
	// Flags
...
func (o *V0044ClusterRec) GetController() V0044ClusterRecController {
	if o == nil || IsNil(o.Controller) {
		var ret V0044ClusterRecController
		return ret
	}
	return *o.Controller
}
...
// SetController gets a reference to the given V0044ClusterRecController and assigns it to the Controller field.
