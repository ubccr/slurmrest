...
type V0044JobTime struct {
	...
	System *V0044JobTimeSystem `json:"system,omitempty"`
	Limit *V0044Uint32NoValStruct `json:"limit,omitempty"`
	Total *V0044JobTimeTotal `json:"total,omitempty"`
	User *V0044JobTimeUser `json:"user,omitempty"`
}
...
// SetSystem gets a reference to the given V0044JobTimeSystem and assigns it to the System field.
...
// SetTotal gets a reference to the given V0044JobTimeTotal and assigns it to the Total field.
...
// SetUser gets a reference to the given V0044JobTimeUser and assigns it to the User field.
