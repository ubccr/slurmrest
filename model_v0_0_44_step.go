...
type V0044Step struct {
	...
	Tasks *V0044StepTasks `json:"tasks,omitempty"`
	...
	Task *V0044StepTask `json:"task,omitempty"`
...
// SetTasks gets a reference to the given V0044StepTasks and assigns it to the Tasks field.
...
// SetTask gets a reference to the given V0044StepTask and assigns it to the Task field.
