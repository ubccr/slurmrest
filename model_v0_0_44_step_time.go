...
type V0044StepTime struct {
	...
	System *V0044StepTimeSystem `json:"system,omitempty"`
	Limit *V0044Uint32NoValStruct `json:"limit,omitempty"`
	Total *V0044StepTimeTotal `json:"total,omitempty"`
	User *V0044StepTimeUser `json:"user,omitempty"`
}
...
// SetSystem gets a reference to the given V0044StepTimeSystem and assigns it to the System field.
...
// SetTotal gets a reference to the given V0044StepTimeTotal and assigns it to the Total field.
...
// SetUser gets a reference to the given V0044StepTimeUser and assigns it to the User field.
